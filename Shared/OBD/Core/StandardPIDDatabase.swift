...
enum StandardPIDDatabase {
    ...
    static let all: [StandardPID] = [
        ...
        .init(pid: 0x00, name: "Supported PIDs 01-20", unit: nil, bytes: 4, description: "Supported PIDs (bitmap)", decoder: OBDPIDDecoderPool.raw),
        // 0x01 Monitor Status Since DTCs Cleared
        .init(pid: 0x01, name: "Monitor Status Since DTCs Cleared", unit: nil, bytes: 4, description: "Monitor status since DTCs cleared", decoder: OBDPIDDecoderPool.raw),
        // 0x02 Freeze DTC
        .init(pid: 0x02, name: "Freeze DTC", unit: nil, bytes: 2, description: "Stored freeze frame DTC", decoder: OBDPIDDecoderPool.raw),
